...
EXPECTED_CLIENT_SUMMARIES = {
    ...
    "--drop client/S3/create_bucket_two_threads_separate_boto.py": {
        "success": 8,
        "failure": 0,
        "crash": 0,
        "timeout": 0,
    },
    "--drop client/mixed/a_s3_bucket_exists_then_ddb_create_table.py":{
        "success": 9,
        "failure": 0,
        "crash": 0,
        "timeout": 0,
    ...
    "--drop client/S3/if_else_bucket_checked_create_vs_delete_shared_boto.py": {
        "success": 9,
        "failure": 0,
        "crash": 0,
        "timeout": 0,
    },
    "--drop client/S3/bucket_checked_create_vs_delete_shared_boto.py": {
        "success": 9,
        "failure": 0,
        "crash": 0,
        "timeout": 0,
    },
    "--drop client/S3/create_bucket_two_threads_shared_boto.py": {
        "success": 8,
        "failure": 0,
        "crash": 0,
        "timeout": 0,
